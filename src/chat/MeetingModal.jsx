  ...
  const handleSubmit = async (e) => {
    ...
    if (isChatForcedOffline()) {
      ...
      const meeting = {
        ...
        scheduled_at: meetingType === 'scheduled' ? `${scheduledDate}T${scheduledTime}` : null,
        duration: meetingType === 'scheduled' ? duration : null,
        created_at: new Date().toISOString(),
      }
      setCreatedMeeting(meeting)
      toast.success('Meeting created (offline — share the code manually).')
