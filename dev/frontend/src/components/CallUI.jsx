...
export function CallUI() {
  const { callState, acceptCall, rejectCall, endCall, toggleMute, toggleVideo, startScreenShare, stopScreenShare, togglePresentationMode, togglePause, startRecording, stopRecording, nextSlide, previousSlide, setAnnotationTool } = useCall()
